...
public class AutoUIManagerLegacy : MonoBehaviour
{
    public static AutoUIManagerLegacy Instance { get; private set; }
    ...
    void CreateStartPanel()
    {
        ...
        CreateText(startPanel.transform, "CUBE MAZE", 60, new Vector2(0, 150), Color.cyan, 800);
        CreateText(startPanel.transform, "Use mouse to steer. Collect smaller cubes, avoid larger ones!", 25, new Vector2(0, 50), Color.white, 600);
    ...
    void CreateGameOverPanel()
    {
        ...
        CreateText(gameOverPanel.transform, "GAME OVER", 60, new Vector2(0, 150), Color.red, 600);
        finalScoreText = CreateText(gameOverPanel.transform, "Score: 0", 35, new Vector2(0, 50), Color.white, 400);
        highScoreText = CreateText(gameOverPanel.transform, "High Score: 0", 28, new Vector2(0, 0), Color.yellow, 400);
    ...
    void CreateHUDPanel()
    {
        ...
        scoreText = CreateText(hudPanel.transform, "Score: 0", 20, new Vector2(-350, -15), Color.white, 200);
        ...
        chainCountText = CreateText(hudPanel.transform, "Chain: 0", 20, new Vector2(350, -15), Color.white, 200);
    ...
    Text CreateText(Transform parent, string text, int fontSize, Vector2 position, Color color, int width)
    {
    ...
    void CreateButton(Transform parent, string buttonText, Vector2 position, Color color, UnityEngine.Events.UnityAction action)
    {
        GameObject btnObj = new GameObject(buttonText.Replace(" ", "") + "Button");
        ...
        colors.highlightedColor = new Color(Mathf.Min(color.r + 0.2f, 1f), Mathf.Min(color.g + 0.2f, 1f), Mathf.Min(color.b + 0.2f, 1f));
